...
int main() {
    ...
    gestor.PesquisarEstudante(202025232);
    ...
    UcTurma temp1 = UcTurma("L.EIC001", "1LEIC05"); // Caso em que o aluno se encontra na turma
    UcTurma temp2 = UcTurma("L.EIC001", "1LEIC11"); // Caso em que o aluno não se encontra na turma
